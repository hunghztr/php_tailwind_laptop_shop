    ...
    <section class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between">
                ...
                ?>
                <form action="./manage-order.php" method="get" class="mt-2 flex">
                    <button id="filterBtn"
                        class="mr-2 w-[130px] h-[40px] bg-blue-500 text-white py-2 rounded-xl hover:bg-blue-600 transition-colors duration-300">
                        Tìm kiếm
                    </button>
                    <input type="text" name='search' id="search" placeholder="Tìm theo mã"
                ...
                <table class="min-w-full bg-white shadow-md rounded-lg">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="py-3 px-6 text-left">Hình thức</th>
                    ...
                    <tbody>
                        ...
                        if (is_numeric($text)) {
                            $sql = $sql . " where id = $text limit $limit offset $offset";
                        } else {
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<tr class='border-b hover:bg-gray-100'>
                                        ...
                                        <td class='py-3 px-6'>$hinh_thuc</td>
                                        <td class='py-3 px-6'>$trang_thai</td>
