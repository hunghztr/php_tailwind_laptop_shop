...
<header class="p-6 mx-auto z-50 fixed top-0 left-0 right-0 shadow-md bg-white">
    <nav class="flex flex-row justify-between items-center relative">
        ...
        <ul class="basis-3/6 ml-16 uppercase font-medium w-20 flex justify-end">
            <li class="py-1 hover:text-gray-800 relative after:lg:absolute after:lg:bottom-0 after:lg:left-0 after:lg:bg-slate-600 after:lg:h-0.5 after:lg:w-0 hover:after:lg:w-full after:lg:transition-all after:lg:ease-in-out after:lg:duration-300"><a href="./cart.php">
